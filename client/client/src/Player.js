...
export default class Player extends Phaser.GameObjects.Sprite {
    ...
    constructor(config) {
        super(config.scene, config.x, config.y, config.key,config.username);
        ...
        this.playerNickname = this.scene.add.text((this.x - this.width * 1.4), (this.y - (this.height / 2)), config.username);
